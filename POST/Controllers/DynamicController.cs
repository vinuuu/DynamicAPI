...
{
	/// <summary>
	/// Used to manage operations on Budget model such as Create, Delete, Insert, get list of Budget model etc
	/// </summary>
	public class @DynamicController : BaseApiController
	{
		...
		/// POST: api/budgeting/@Parentmodel/@Dynamic
		/// <summary>
		/// Creating New of @Dynamic details
		/// </summary>
		/// <remarks>Creating New of @Dynamic details</remarks>
		...
		[HttpPut]
		[Route("@Parent/setup/@DynamicInsert")]
		public HttpResponseMessage Insert@Dynamic([FromBody] @Dynamic @Dynamic)
		{
			...
			Response resp = _I@Parentmanager.Insert@Dynamic(inputObjects, globals,@Dynamic);
