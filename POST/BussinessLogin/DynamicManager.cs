...
namespace RealPage.OneSite.Budgeting.BudgetModels.BusinessLogic
{
	...
	public class @ParentManager : BaseManager, I@ParentManager
	{
		...
		public Response Insert@Dynamic(IDictionary<object, object> inputObjects, IDictionary<object, object> globals, @Dynamic prototype)
		{
			...
			try
			{
				...
				bot.Action = new RPComponents.Action(RPComponents.Action.Insert);
