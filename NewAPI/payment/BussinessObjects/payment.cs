...
namespace RealPage.OneSite.Budgeting.BudgetModels.BusinessObjects
{
	...
	/// <summary>
	public class payment : BusinessObjectBase, Ipayment
	{
...
private PropertyAttributes _capEffectiveMonth;
		...
		#region Constructors
		/// <summary>
		/// Create a basic instance of the payment class
		/// <summary>
		public payment()
		{
		}
		...
		public payment(IEnvironment env) : base(env)
		{
		}
		/// <summary>
		/// Create a basic instance of the payment class
		...
		public payment(BusinessObjectBase bob) : base(bob)
		{
		}
		#endregion
...
set { _capEffectiveMonth.Value = value; } 
		...
		#region Examples
		/// <summary>
		/// Used to get an example of the payment object with test data
		/// </summary>
		/// <returns>List of payment Model with test data</returns>
		public static List<Ipayment> GetpaymentExample()
		{
