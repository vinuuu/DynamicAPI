...
{
	/// <summary>
	///  Provides the interface for payment Manager 
	/// </summary>
	public interface IundefinedManager : IBaseManager
	{
		...
		List<Ipayment> Getpayment(IDictionary<object, object> inputObjects, IDictionary<object, object> globals, Ipayment prototype);
	}
}