...
namespace RealPage.OneSite.Budgeting.BudgetModels.DAO
{
	...
	public class undefinedDAO : DAOBase, IundefinedDAO
	{
		...
		public new class WorkingTypes
		{
			...
			/// </summary>
			public const String Response = "searchResponse";
			/// <summary>
			/// Working type for SequenceList
			/// </summary>
			public const String SequenceList = "searchSequenceList";
			/// <summary>
			/// Working type for Exception
			/// </summary>
			public const String Exception = "searchException";
			/// <summary>
			/// Working type for search
			/// </summary>
			...
			)
		{
			...
			{
				IList<Isearch> search = new List<Isearch>();
				while (reader.Read())
				{
					Isearch bob = (Isearch)db.BuildObject(reader);
					search.Add(bob);
					bot.Status = new TransactionStatus(TransactionStatus.Succeeded);
				}
				workingObjects.Add(WorkingTypes.search, search);
