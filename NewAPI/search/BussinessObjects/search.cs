...
{
	/// <summary>
	/// Used to Manage search
	/// <summary>
	public class search : BusinessObjectBase, Isearch
	{
...
private PropertyAttributes _capEffectiveMonth;
		...
		#region Constructors
		/// <summary>
		/// Create a basic instance of the search class
		/// <summary>
		public search()
		{
		}
		...
		public search(IEnvironment env) : base(env)
		{
		}
		/// <summary>
		/// Create a basic instance of the search class
		...
		public search(BusinessObjectBase bob) : base(bob)
		{
		}
		#endregion
...
set { _capEffectiveMonth.Value = value; } 
		...
		#region Examples
		/// <summary>
		/// Used to get an example of the search object with test data
		/// </summary>
		/// <returns>List of search Model with test data</returns>
		public static List<Isearch> GetsearchExample()
		{
			List<Isearch> list = new List<Isearch>();
