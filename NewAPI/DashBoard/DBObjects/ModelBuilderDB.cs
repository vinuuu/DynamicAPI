...
namespace RealPage.OneSite.Budgeting.BudgetModels.DBObjects
{
	...
	public class ModelBuilderDB : DBObjectBase, IModelBuilderDB
	{
		#region Constructor
		/// <summary>
		/// Create an instance of a ModelBuilderDB DB Object
		/// </summary>
		/// <param name="businessObject"></param>
		/// <param name="parameters"></param>
		public ModelBuilderDB(IBusinessObjectBase businessObject, Hashtable parameters)
