...
namespace RealPage.OneSite.Budgeting.BudgetModels.BusinessLogic
{
	...
	public class @ParentManager : BaseManager, I@ParentManager
	{
		...
		public List<I@Dynamic> Get@Dynamic(IDictionary<object, object> inputObjects, IDictionary<object, object> globals, I@Dynamic prototype)
		{
			...
			List<I@Dynamic> list = (List<I@Dynamic>)workingObjects[@ParentDAO.WorkingTypes.@Dynamic];
			return list;
		}
		#endregion
	}
